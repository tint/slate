...
Unknown custom attributes are allowed and emitted literally. Project-specific
warnings such as preferring `class` over `className` belong in
`html.attributeDiagnostics`.
