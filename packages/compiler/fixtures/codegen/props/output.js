...
export async function render(__props = {}, slots = {}, context = {}) {
  ...
  __html += [
    "<h1",
    ">",
    escapeHTML(evaluateSlateExpression(() => (title), {"filename":"component.slate","range":{"start":155,"end":160},"kind":"template"})),
    "</h1>"
  ].join("");
  __html += "\n";
  __html += [
    "<p",
    ">",
    escapeHTML(evaluateSlateExpression(() => (props.count), {"filename":"component.slate","range":{"start":171,"end":182},"kind":"template"})),
    "</p>"
  ].join("");
  __html += "\n";
  return __html;
